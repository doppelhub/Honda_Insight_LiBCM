...
const uint16_t remap_actualToSpoofedSoC[101] = {
    ...
    360,365,370,375,380,385,390,395,400,405, //LiCBM SoC = 30% to 39% 
    410,415,420,425,430,435,440,445,450,455, //LiCBM SoC = 40% to 49%
    460,465,470,475,480,485,490,495,500,505, //LiCBM SoC = 50% to 59% 
    510,515,520,525,530,535,540,554,568,582, //LiCBM SoC = 60% to 69% 
    596,610,624,638,652,666,680,694,708,722, //LiCBM SoC = 70% to 79%
    736,750,764,778,792,799,800,814,829,843, //LiCBM SoC = 80% to 89% 
